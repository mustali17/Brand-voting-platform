...
export default function SearchOverlay({ isOpen, onClose }: SearchOverlayProps) {
  ...
  return (
    <div className='fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex flex-col overflow-y-auto'>
      <div className='p-4 sm:p-6 max-w-3xl mx-auto w-full'>
        ...
        <div className='grid gap-2'>
          {[
            ...
            <button
              key={item}
              className='flex items-center gap-3 p-3 rounded-lg hover:bg-white/10 text-white text-left transition-colors'
              onClick={() => {
