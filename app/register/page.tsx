  ...
  return (
    sessionStatus !== 'authenticated' && (
      <div className='flex flex-row grid-cols-1 w-full'>
        <div className='flex min-h-full flex-1 flex-col justify-center py-12 lg:py-0 sm:px-6 lg:px-8'>
          <div className='flex justify-center flex-col items-center'>
            <h2 className='lg:mt-6 sm:mt-6 text-center text-2xl leading-9 tracking-tight text-gray-900'>
