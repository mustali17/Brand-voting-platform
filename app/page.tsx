      ...
      <div className="w-60 border-r border-gray-300 hidden md:flex flex-col">
        <nav className="flex-1">
          <div className="space-y-1 px-3">
            <Link href="#" className="flex items-center px-3 py-3 text-sm font-medium rounded-md hover:bg-gray-100">
            ...
            <div className="flex space-x-4 overflow-x-auto pb-2">
              {[
                ...
                <div key={i} className="flex flex-col items-center">
                             <Image src="/images/post.jpg" alt="Profile" width={56} height={56} className="rounded-full w-14 h-14 mr-4" />
          ...
          <div className="max-w-xl mx-auto w-full">
            ...
            <div className="border-b border-gray-300 pb-4">
              ...
              <div className="flex items-center p-3">
                <div className="flex items-center">
                <Image src="/images/post.jpg" alt="Profile" width={56} height={56} className="rounded-full w-8 h-8 mr-4" />
          ...
          <div key={i} className="flex items-center mb-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-gray-500 text-xs">
                Followed by {suggestion.followedBy} {suggestion.time && `+ ${suggestion.time}`}
              </div>
            </div>
